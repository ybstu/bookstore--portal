...
function Book({
    ...
    return (
        <>
            ...
            />
            <div className="book-card-e col-lg-3 col-md-4 col-sm-6 col-12 g-3">
                {isAdmin && (
                    <div
                    ...
                    <div className="actionButtons">
                        <LinkContainer to={"/books/" + name}>
                            ...
                            <button
                                ...
                                className="text-center btn btn-outline-danger btn-sm mt-2"
                            >
                                Details -&gt;
                            </button>
                        </LinkContainer>
                        {quantity > 0 ? (
                            ...
                            <button
                                className="text-center btn btn-outline-danger mt-2"
                                onClick={() => handleAddToCart(id)}
                                disabled
                            >
                                Add to cart
